...
| **4/10**  |  Team 19  <br> [peer-review](https://) <br>    Team 20 <br> [peer-review](https://) |  **Presentation** – <br>  Medical Image Segmentation with Foundation Models   | Segment anything model for medical image analysis: An experimental study <br> Medical Image Analysis [paper]()  |  Submit review <br> Submit peer-grading           |
